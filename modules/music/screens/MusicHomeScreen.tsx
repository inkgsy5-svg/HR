...
export default function MusicHomeScreen() {
  ...
  function handleArtistPress(artist: Artist) {
    navigation.navigate('MusicDetail', { id: artist.id });
  }
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Banner */}
        <ImageBackground
          source={require('../../../assets/images/music/music-artists.jpeg')}
          style={styles.banner}
          resizeMode="cover"
        >
          <LinearGradient
          ...
          >
            <Text style={styles.bannerTitle}>Música 🎵</Text>
          </LinearGradient>
        </ImageBackground>

        {/* DJs / Artistas */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Elige tu DJ</Text>
