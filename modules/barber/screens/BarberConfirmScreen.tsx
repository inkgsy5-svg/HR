...
type Nav = StackNavigationProp<BarberStackParamList, 'BarberConfirm'>;
type Route = RouteProp<BarberStackParamList, 'BarberConfirm'>;

export default function BarberConfirmScreen() {
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.subtitle}>Te esperamos con {params.barberName}</Text>
        </Animated.View>
        ...
        >
          <View style={styles.cardRow}>
            ...
            <View style={styles.cardInfo}>
              ...
              <Text style={styles.cardValue}>{params.barberName}</Text>
            </View>
          </View>
